...
showFrame = insertText(showFrame,[0,0],['Current Voltage =' num2str(LightPulse.CurrentVoltage)]);
showFrame = insertText(showFrame,[0,50],['TimeFromLastShake =' num2str(minutes(LightPulse.TimeSinceLastPulse))]);
showFrame = insertText(showFrame,[0,100],['Shaking Initialized =' num2str(LightPulse.LightsOn)]);
